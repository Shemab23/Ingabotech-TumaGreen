...
import { Leaf, DollarSign, Users, TrendingUp, Send } from 'lucide-react';
import { useUser } from '@/context/UserContext';
import RiderCard from '@/components/RiderCard';

const BecomeRiderSection = () => {
  const { riders, handleBookRider, handleBecomeRiderSubmit } = useUser();
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    handleBecomeRiderSubmit(formData);
  };
